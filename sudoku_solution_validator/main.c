...
// https://www.codewars.com/kata/529bf0e9bdf7657179000008/train/c
//
// Sudoku Background
//
...
// is a valid solution, or false otherwise. 
...
int main (int argc, char* argv[]) {
    ...
    assert(validSolution(example1) == false);
